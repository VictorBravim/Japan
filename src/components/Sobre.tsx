...
const AccordionItem: React.FC<{ title: string; content: string; isFirst: boolean }> = ({
    ...
    const [isOpen, setIsOpen] = useState(isFirst); // Define o estado inicial com base na propriedade isFirst
      ...
      <div className="relative z-10 text-white w-full lg:w-1/2 lg:ml-8">
        ...
        {accordionData.map((item, index) => (
          <AccordionItem
            ...
            isFirst={index === 0} // Define isFirst como true apenas para o primeiro item
          />
        ))}
      </div>
    </div>
